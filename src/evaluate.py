...
df_train_ = pd.read_csv('mlops/aircraft-engine-run-to-failure/src/prepare_data/df_train_.csv', sep = ',')
df_train_=df_train_.drop(columns=["Unnamed: 0"])
df_test_ = pd.read_csv('mlops/aircraft-engine-run-to-failure/src/prepare_data/df_test_.csv', sep = ',')
...
pkl_filename = "mlops/aircraft-engine-run-to-failure/src/models/LinearRegression_model.pkl"
pkl_filename_polyreg = "mlops/aircraft-engine-run-to-failure/src/models/polyreg_model.pkl"
pkl_filename_lasso = "mlops/aircraft-engine-run-to-failure/src/models/Lasso_model.pkl"
pkl_filename_DecisionTreeRegressor = "mlops/aircraft-engine-run-to-failure/src/models/DecisionTreeRegressor_model.pkl"
pkl_filename_rf = "mlops/aircraft-engine-run-to-failure/src/models/RandomForestRegressor.pkl"
...
result2 = results.to_json('mlops/aircraft-engine-run-to-failure/src/export.json', orient='index')